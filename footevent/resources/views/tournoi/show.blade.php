  ...
  <div class="max-w-6xl mx-auto px-8 py-10">
    ...
    @if($tournoi->user_id == auth()->id())
          ...
          <div class="flex flex-col gap-2 flex-shrink-0">
            <a href="#" class="flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-700 text-sm text-gray-300 hover:border-green-600 hover:text-green-400 transition-colors">
